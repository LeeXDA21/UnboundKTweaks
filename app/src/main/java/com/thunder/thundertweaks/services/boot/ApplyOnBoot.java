 ...
 *
 */
package com.thunder.thundertweaks.services.boot;
...
import com.thunder.thundertweaks.utils.NotificationId;
    ...
    public static boolean apply(ApplyOnBootService service, final ApplyOnBootListener listener) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                RootUtils.runCommand("setprop thundertweaks.applied_onboot 1");
            }
        }).start();
        return true;
    }
